...
/* harmony import */ var _modules_move_block__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/move-block */ "./js/modules/move-block.js");
/* harmony import */ var _modules_open_accordion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/open-accordion */ "./js/modules/open-accordion.js");
/* harmony import */ var _modules_scroll_section__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/scroll-section */ "./js/modules/scroll-section.js");
/* harmony import */ var _modules_save_localstorage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/save-localstorage */ "./js/modules/save-localstorage.js");
...
Object(_utils_phone_mask__WEBPACK_IMPORTED_MODULE_2__["initPhoneMask"])(); // Modules
// ---------------------------------

Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_3__["initModals"])();
Object(_modules_open_accordion__WEBPACK_IMPORTED_MODULE_5__["openAccordion"])();
Object(_modules_move_block__WEBPACK_IMPORTED_MODULE_4__["moveBlock"])();
Object(_modules_scroll_section__WEBPACK_IMPORTED_MODULE_6__["scrollToSection"])();
Object(_modules_save_localstorage__WEBPACK_IMPORTED_MODULE_7__["saveInLocalstorage"])();
...
var inputName = document.querySelector('#name-modal'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalFeedback && modalFeedbackBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalFeedback, false, modalFeedbackBtns, addFocus, false);
  }
...
/***/ "./js/modules/move-block.js":
/*!**********************************!*\
  !*** ./js/modules/move-block.js ***!
  \**********************************/
/*! exports provided: moveBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveBlock", function() { return moveBlock; });
var block = document.querySelector('[data-move="block"]');
var blockOnMobile = document.querySelector('[data-move="mobile"]');
var blockOnDesktop = document.querySelector('[data-move="desktop"]');
...
var content = document.querySelector('.footer__content');
var title = document.querySelectorAll('.accordion__title'); // const breakpointMobile = window.matchMedia('(max-width:767px)');

var openAccordion = function openAccordion() {
  var openMenu = function openMenu(i) {
    accordionContent[i].classList.toggle('active');
    accordionBtn[i].classList.toggle('active');
  };

  var closeMenu = function closeMenu(i) {
    accordionContent[i].classList.remove('active');
    accordionBtn[i].classList.remove('active');
  };

  var buttonAccordion = function buttonAccordion(btnSelector, e) {
  ...
  var initAccordion = function initAccordion(e) {
...
/***/ "./js/modules/save-localstorage.js":
/*!*****************************************!*\
  !*** ./js/modules/save-localstorage.js ***!
  \*****************************************/
/*! exports provided: saveInLocalstorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var btnForm = document.querySelectorAll('.form__send');
var modalForm = document.querySelector('.modal');

var saveInLocalstorage = function saveInLocalstorage() {
  var saveInput = function saveInput() {
    var inputArray = Array.from(document.querySelectorAll('[data-set="save"]'));
    var valueJson = JSON.stringify(inputArray.map(function (item) {
      return item.value;
    }));
    localStorage.setItem('value', valueJson);
  };

  btnForm.forEach(function (item) {
...
var scrollLiks = document.querySelectorAll('[data-scroll="link"]');

var scrollToSection = function scrollToSection() {
  scrollLiks.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      var idLink = item.getAttribute('href').substring(1);
